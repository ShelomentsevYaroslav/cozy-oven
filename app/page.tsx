...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-[#E8D8C3] text-[#A0522D] overflow-x-hidden">

      {/* 🌿 DESKTOP VINES */}
      <div className="hidden lg:block fixed left-0 top-0 h-full pointer-events-none z-0">
        <img
          src="/images/left-vine.png"
          alt=""
          className="h-full w-[500px] object-cover opacity-60 -translate-x-1/6"
        />
      </div>

      <div className="hidden lg:block fixed right-0 top-0 h-full pointer-events-none z-0">
        <img
          src="/images/right-vine.png"
          alt=""
          className="h-full w-[500px] object-cover opacity-60 translate-x-1/6"
        />
      </div>
      ...
      {/* CHECKOUT */}
      <section id="checkout" className="py-20 px-6 bg-[#E8D8C3] relative z-10">
        <div className="max-w-3xl mx-auto">
          ...
          <form className="space-y-4 bg-white p-6 rounded-2xl shadow-md">
            ...
            <button type="submit" className="w-full bg-[#4CAF50] text-white py-3 rounded-lg">
              Place Order
            </button>
          </form>
        </div>
      ...
      {/* FOOTER */}
      <footer className="py-12 text-center border-t border-[#F4A7B9]/40 bg-white relative z-10">
        <p>Central Tyumen</p>
        <p>8:00 AM – 9:00 PM</p>
